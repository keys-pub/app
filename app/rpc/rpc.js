...
// InputID: 2618fe29ddd027e72fd3634b551b284c6d6e8266
...
export const keyImport = (req: KeyImportRequest, respFn: ?(resp: KeyImportResponse) => void, errFn: ?(err: RPCError) => void) => async (dispatch: (action: any) => void) => {
  dispatch({
...
export const keyExport = (req: KeyExportRequest, respFn: ?(resp: KeyExportResponse) => void, errFn: ?(err: RPCError) => void) => async (dispatch: (action: any) => void) => {
  dispatch({
...
export const statement = (req: StatementRequest, respFn: ?(resp: StatementResponse) => void, errFn: ?(err: RPCError) => void) => async (dispatch: (action: any) => void) => {
  dispatch({
    type: 'KEYS_STATEMENT_REQUEST',
		payload: req,
	})
	let cl = await client()
  cl.statement(req, (err: ?RPCError, resp: ?StatementResponse) => {
    if (err) {
      if (errFn) {
        console.error(err)
        errFn(err)      
...
export const statementCreate = (req: StatementCreateRequest, respFn: ?(resp: StatementCreateResponse) => void, errFn: ?(err: RPCError) => void) => async (dispatch: (action: any) => void) => {
  dispatch({
    type: 'KEYS_STATEMENT_CREATE_REQUEST',
		payload: req,
	})
	let cl = await client()
  cl.statementCreate(req, (err: ?RPCError, resp: ?StatementCreateResponse) => {
    if (err) {
      if (errFn) {
        console.error(err)
        errFn(err)      
...
export const statementRevoke = (req: StatementRevokeRequest, respFn: ?(resp: StatementRevokeResponse) => void, errFn: ?(err: RPCError) => void) => async (dispatch: (action: any) => void) => {
  dispatch({
    type: 'KEYS_STATEMENT_REVOKE_REQUEST',
		payload: req,
	})
	let cl = await client()
  cl.statementRevoke(req, (err: ?RPCError, resp: ?StatementRevokeResponse) => {
    if (err) {
      if (errFn) {
        console.error(err)
        errFn(err)      
...
export const authGenerate = (req: AuthGenerateRequest, respFn: ?(resp: AuthGenerateResponse) => void, errFn: ?(err: RPCError) => void) => async (dispatch: (action: any) => void) => {
  dispatch({
...
export type RPCState = {
  ...
  keyImportRequest: ?KeyImportRequest,
  keyImport: ?KeyImportResponse,
  keyExportLoading: boolean,
  keyExportRequest: ?KeyExportRequest,
  keyExport: ?KeyExportResponse,
  ...
  statementRevokeRequest: ?StatementRevokeRequest,
  statementRevoke: ?StatementRevokeResponse,
  ...
  authGenerateRequest: ?AuthGenerateRequest,
  authGenerate: ?AuthGenerateResponse,
