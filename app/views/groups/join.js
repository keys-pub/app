...
class GroupJoinView extends Component<Props, State> {
  state = {
    key: '',
    error: null,
  }
        ...
        <FormControl error={!!this.state.error}>
          <Input
            ...
            onChange={(e: SyntheticInputEvent<EventTarget>) =>
              this.setState({error: null, key: e.target.value})
            }
            onFocus={(e: SyntheticInputEvent<EventTarget>) => this.setState({error: null})}
          />
...
export default connect<Props, {}, _, _, _, _>()(GroupJoinView)
