...
import type {Document, DocumentsRequest, DocumentsResponse} from '../../rpc/types'
...
class DBVListView extends Component<Props> {
  list: Array<Row> = []
  cellCache: any
    ...
    return new Promise((resolve, reject) => {
      ...
      this.props.dispatch(
        documents(req, (resp: DocumentsResponse) => {
          ...
          let i = r.startIndex
          // $FlowFixMe
          for (const doc: Document of resp.documents) {
            this.list[i++] = {doc}
          }
          resolve()
        })
...
export default connect<Props, {}, _, _, _, _>(mapStateToProps)(DBVListView)
