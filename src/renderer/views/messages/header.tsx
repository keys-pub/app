...
import {Inbox, Message, User} from '../../rpc/types'
...
export default class MessagesHeaderView extends React.Component<Props, State> {
  state = {
    menuAnchor: null,
  }
  ...
  render() {
    const inbox: Inbox | void = this.props.inbox
