...
// InputID: f05a823508b5507504ee922b3b75516e93e872b7
...
export const verifyDetached = (
  ...
  const reply = 'verifyDetached-' + replyID()
  ipcRenderer.on(reply, (event, arg) => {
    ipcRenderer.removeAllListeners(reply)
    if (arg.err) {
      console.error('RPC error (verifyDetached):', arg.err)
      errHandler(arg.err)
    } else {
      console.log('RPC (verifyDetached) done')
    }
    cb(arg.err, arg.resp)
  })
  console.log('RPC (verifyDetached)...')
  ipcRenderer.send('rpc', {method: 'verifyDetached', args: req, reply: reply})
}
...
export const verifyDetachedFile = (
  ...
  const reply = 'verifyDetachedFile-' + replyID()
  ipcRenderer.on(reply, (event, arg) => {
    ipcRenderer.removeAllListeners(reply)
    if (arg.err) {
      console.error('RPC error (verifyDetachedFile):', arg.err)
      errHandler(arg.err)
    } else {
      console.log('RPC (verifyDetachedFile) done')
    }
    cb(arg.err, arg.resp)
  })
  console.log('RPC (verifyDetachedFile)...')
  ipcRenderer.send('rpc', {method: 'verifyDetachedFile', args: req, reply: reply})
}
...
export const verifyDetachedStream = (
  ...
  const reply = 'verifyDetachedStream-' + replyID()
  ipcRenderer.on(reply, (event, arg) => {
    ipcRenderer.removeAllListeners(reply)
    if (arg.err) {
      console.error('RPC error (verifyDetachedStream):', arg.err)
      errHandler(arg.err)
    } else {
      console.log('RPC (verifyDetachedStream) done')
    }
    cb(arg.err, arg.resp)
  })
  console.log('RPC (verifyDetachedStream)...')
  ipcRenderer.send('rpc', {method: 'verifyDetachedStream', args: req, reply: reply})
}
