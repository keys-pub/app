...
// InputID: 633a21d45ac5f8bb2a9e6badf198f2906bbc307d
...
export const authVault = (
  req: AuthVaultRequest,
  cb: (err: RPCError, resp: AuthVaultResponse) => void
) => {
...
export const passwordChange = (
  ...
  cb: (err: RPCError, resp: PasswordChangeResponse) => void
) => {
...
export const vaultAuth = (
  req: VaultAuthRequest,
  cb: (err: RPCError, resp: VaultAuthResponse) => void
) => {
...
export const vaultSync = (
  req: VaultSyncRequest,
  cb: (err: RPCError, resp: VaultSyncResponse) => void
) => {
...
export const vaultUnsync = (
  req: VaultUnsyncRequest,
  cb: (err: RPCError, resp: VaultUnsyncResponse) => void
) => {
...
export const vaultStatus = (
  req: VaultStatusRequest,
  cb: (err: RPCError, resp: VaultStatusResponse) => void
) => {
...
export const vaultUpdate = (
  ...
  cb: (err: RPCError, resp: VaultUpdateResponse) => void
) => {
