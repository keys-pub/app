...
// InputID: 02031eb58030ca93ffaf8ad0dca5c18c3bbd1eeb
...
export const user = (req: UserRequest, respFn: ((resp: UserResponse) => void) | void, errFn: ErrFn | void) => async (dispatch: (action: any) => void) => {
  dispatch({
