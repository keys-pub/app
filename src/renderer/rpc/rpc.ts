...
// InputID: 4589bbcea279c2f4b3bb095971df4387c115bf1c
...
export const signStream = (req: SignStreamInput, respFn: ((resp: SignStreamOutput) => void) | void, errFn: ErrFn | void) => async (dispatch: (action: any) => void) => {
  dispatch({
    type: 'KEYS_SIGN_STREAM_REQUEST',
		payload: req,
	})
	let cl = await client()
  cl.signStream(req, (err: RPCError|void, resp: SignStreamOutput | void) => {
    if (err) {
      if (errFn) {
        console.error(err)
        errFn(err)      
...
export const verifyStream = (req: VerifyStreamInput, respFn: ((resp: VerifyStreamOutput) => void) | void, errFn: ErrFn | void) => async (dispatch: (action: any) => void) => {
  dispatch({
    type: 'KEYS_VERIFY_STREAM_REQUEST',
		payload: req,
	})
	let cl = await client()
  cl.verifyStream(req, (err: RPCError|void, resp: VerifyStreamOutput | void) => {
    if (err) {
      if (errFn) {
        console.error(err)
        errFn(err)      
...
export const verifyArmoredStream = (req: VerifyStreamInput, respFn: ((resp: VerifyStreamOutput) => void) | void, errFn: ErrFn | void) => async (dispatch: (action: any) => void) => {
  dispatch({
    type: 'KEYS_VERIFY_ARMORED_STREAM_REQUEST',
		payload: req,
	})
	let cl = await client()
  cl.verifyArmoredStream(req, (err: RPCError|void, resp: VerifyStreamOutput | void) => {
    if (err) {
      if (errFn) {
        console.error(err)
        errFn(err)      
...
export const encryptStream = (req: EncryptStreamInput, respFn: ((resp: EncryptStreamOutput) => void) | void, errFn: ErrFn | void) => async (dispatch: (action: any) => void) => {
  dispatch({
    type: 'KEYS_ENCRYPT_STREAM_REQUEST',
		payload: req,
	})
	let cl = await client()
  cl.encryptStream(req, (err: RPCError|void, resp: EncryptStreamOutput | void) => {
    if (err) {
      if (errFn) {
        console.error(err)
        errFn(err)      
...
export const decryptStream = (req: DecryptStreamInput, respFn: ((resp: DecryptStreamOutput) => void) | void, errFn: ErrFn | void) => async (dispatch: (action: any) => void) => {
  dispatch({
    type: 'KEYS_DECRYPT_STREAM_REQUEST',
		payload: req,
	})
	let cl = await client()
  cl.decryptStream(req, (err: RPCError|void, resp: DecryptStreamOutput | void) => {
    if (err) {
      if (errFn) {
        console.error(err)
        errFn(err)      
...
export const decryptArmoredStream = (req: DecryptStreamInput, respFn: ((resp: DecryptStreamOutput) => void) | void, errFn: ErrFn | void) => async (dispatch: (action: any) => void) => {
  dispatch({
    type: 'KEYS_DECRYPT_ARMORED_STREAM_REQUEST',
		payload: req,
	})
	let cl = await client()
  cl.decryptArmoredStream(req, (err: RPCError|void, resp: DecryptStreamOutput | void) => {
    if (err) {
      if (errFn) {
        console.error(err)
        errFn(err)      
...
export const signcryptOpenStream = (req: DecryptStreamInput, respFn: ((resp: DecryptStreamOutput) => void) | void, errFn: ErrFn | void) => async (dispatch: (action: any) => void) => {
  dispatch({
    type: 'KEYS_SIGNCRYPT_OPEN_STREAM_REQUEST',
		payload: req,
	})
	let cl = await client()
  cl.signcryptOpenStream(req, (err: RPCError|void, resp: DecryptStreamOutput | void) => {
    if (err) {
      if (errFn) {
        console.error(err)
        errFn(err)      
...
export const signcryptOpenArmoredStream = (req: DecryptStreamInput, respFn: ((resp: DecryptStreamOutput) => void) | void, errFn: ErrFn | void) => async (dispatch: (action: any) => void) => {
  dispatch({
    type: 'KEYS_SIGNCRYPT_OPEN_ARMORED_STREAM_REQUEST',
		payload: req,
	})
	let cl = await client()
  cl.signcryptOpenArmoredStream(req, (err: RPCError|void, resp: DecryptStreamOutput | void) => {
    if (err) {
      if (errFn) {
        console.error(err)
        errFn(err)      
...
export const authGenerate = (req: AuthGenerateRequest, respFn: ((resp: AuthGenerateResponse) => void) | void, errFn: ErrFn | void) => async (dispatch: (action: any) => void) => {
  dispatch({
    type: 'KEYS_AUTH_GENERATE_REQUEST',
		payload: req,
	})
	let cl = await client()
  cl.authGenerate(req, (err: RPCError|void, resp: AuthGenerateResponse | void) => {
    if (err) {
      ...
      if (errHandler) {
        ...
        dispatch({
          type: 'ERROR',
          payload: {error: err, action: 'KEYS_AUTH_GENERATE', req},
        })
      }
      return
    }
    if (resp && respFn) respFn(resp)
      dispatch({
        type: 'KEYS_AUTH_GENERATE_RESPONSE',
        payload: resp,
      })
    })
  }
...
export type RPCState = {
  ...
  signStreamRequest: SignStreamInput | void,
  signStream: SignStreamOutput | void,
  verifyStreamLoading: boolean,
  verifyStreamRequest: VerifyStreamInput | void,
  verifyStream: VerifyStreamOutput | void,
  verifyArmoredStreamLoading: boolean,
  verifyArmoredStreamRequest: VerifyStreamInput | void,
  verifyArmoredStream: VerifyStreamOutput | void,
  ...
  encryptStreamRequest: EncryptStreamInput | void,
  encryptStream: EncryptStreamOutput | void,
  decryptStreamLoading: boolean,
  decryptStreamRequest: DecryptStreamInput | void,
  decryptStream: DecryptStreamOutput | void,
  decryptArmoredStreamLoading: boolean,
  decryptArmoredStreamRequest: DecryptStreamInput | void,
  decryptArmoredStream: DecryptStreamOutput | void,
  signcryptOpenStreamLoading: boolean,
  signcryptOpenStreamRequest: DecryptStreamInput | void,
  signcryptOpenStream: DecryptStreamOutput | void,
  signcryptOpenArmoredStreamLoading: boolean,
  signcryptOpenArmoredStreamRequest: DecryptStreamInput | void,
  signcryptOpenArmoredStream: DecryptStreamOutput | void,
  ...
  authGenerateLoading: boolean,
  authGenerateRequest: AuthGenerateRequest | void,
  authGenerate: AuthGenerateResponse | void,
...
const initialState: RPCState = {
  ...
  configSet: null,
  authGenerateLoading: false,
  authGenerateRequest: null,
  authGenerate: null,
...
export const reducer = (state: RPCState = initialState, action: any) => {
  switch (action.type) {
		...
		case 'KEYS_AUTH_GENERATE_REQUEST': {
			return {
				...state,
				authGenerateLoading: false,
				authGenerateRequest: action.payload,
		  }
		}
		case 'KEYS_AUTH_GENERATE_RESPONSE': {
			return {
				...state,
				authGenerateLoading: false,
				authGenerateRequest: null,
				authGenerate: action.payload,
			}
		}
